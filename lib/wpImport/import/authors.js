...
function authors(_x, _x2, _x3) {
  return _authors.apply(this, arguments);
}

function _authors() {
  _authors = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(
      dato,
      wp,
      itemTypeId,
    ) {
      var mapping, resources, tick, _iterator, _step, author;
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              ...
              case 3:
                ...
                tick = progress('Creating authors', resources.length);
              ...
              case 12:
                mapping[author.id] = _context.sent.id;
