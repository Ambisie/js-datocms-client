...
var _seoTagsBuilder = _interopRequireDefault(
  require('../utils/seoTagsBuilder'),
);
  ...
  _createClass(Item, [
    {
      ...
      value: function autogeneratedSlug() {
        var _ref =
          ...
          prefixWithId =
            _ref$prefixWithId === void 0 ? true : _ref$prefixWithId;
        ...
        if (title && prefixWithId) {
          return ''
            .concat(this.id, '-')
            .concat((0, _slugify['default'])(title));
        }
      ...
      value: function toMap() {
        ...
        return this.fields.reduce(function(acc, field) {
          ...
          return Object.assign(
            ...
            _defineProperty(
              {},
              (0, _humps.camelize)(field.apiKey),
              serializedValue,
            ),
          );
        }, result);
    ...
    },
    {
      ...
      get: function get() {
        ...
        if (seoField) {
          return (0, _seoTagsBuilder['default'])(
            this.entity,
            this.entity.repo,
            _i18n['default'],
          );
